      ...
      <div className="mx-auto mt-24 max-w-4xl px-4">
        ...
        <div className="space-y-10 text-neutral-800 mb-16">
          ...
          <div>
            ...
            <p className="mt-2 text-sm leading-relaxed">
              El taller propone una experiencia creativa centrada en el proceso, experimentar con arcilla, explorar texturas y desarrollar paciencia, concentración y creatividad.
            </p>
          </div>
          ...
          <div>
            ...
            <p className="mt-2 text-sm leading-relaxed">
              Taller orientado al desarrollo artístico, corporal y emocional.
              Un espacio para conectar con el cuerpo y el estilo propio, fortaleciendo la confianza y la expresión desde la autenticidad.
            </p>
          </div>
          ...
          <div>
            ...
            <p className="text-sm italic">Martín Mezquita · 📞 2984570978 · Instagram: @martinmezquita_92</p>
            <p className="mt-2 text-sm"><strong>Edad:</strong> 18 años en adelante</p>
            <p className="mt-2 text-sm"><strong>Día y horario:</strong> Jueves de 19:30 a 21:00 hs</p>
            <p className="mt-2 text-sm leading-relaxed">
              Taller de tango con enfoque corporal y musical. Se trabajarán postura, caminata, interpretación musical y coordinación en pareja.
              Grupos reducidos y personalizados según franjas etarias.
            </p>
          </div>
          ...
          <div>
            ...
            <p className="mt-2 text-sm leading-relaxed">
              Taller de arquitectura de verano, con desafíos de construcción y maquetas, aprendiendo estructuras y contenidos de arquitectura mientras se divierten y se desafían.
            </p>
          </div>
